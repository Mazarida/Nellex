...
<div class="bx-system-auth-form">
	...
	<?if ($arResult["FORM_TYPE"] == "login"):?>
		<form name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>" class="login__form">
			...
			<noindex><a href="<?=$arResult["AUTH_FORGOT_PASSWORD_URL"]?>" class="forgot-pass" rel="nofollow"><?=Loc::getMessage("AUTH_FORGOT_PASSWORD_2")?></a></noindex>
			...
			<table width="95%">
				...
				<?if ($arResult["REMEMBER_OTP"] == "Y"):?>
					<tr>
						...
						<td width="100%"><label for="OTP_REMEMBER_frm" title="<?echo Loc::getMessage("auth_form_comp_otp_remember_title")?>"><?echo Loc::getMessage("auth_form_comp_otp_remember")?></label></td>
					</tr>
				<?endif?>
				<tr>
					<td colspan="2"><input type="submit" name="Login" value="<?=Loc::getMessage("AUTH_LOGIN_BUTTON")?>" /></td>
				</tr>
				<tr>
					<td colspan="2"><noindex><a href="<?=$arResult["AUTH_LOGIN_URL"]?>" rel="nofollow"><?echo Loc::getMessage("auth_form_comp_auth")?></a></noindex><br /></td>
				</tr>
			</table>
		</form>
			...
			<table width="95%">
				<tr>
					<td align="center">
						...
						<a href="<?=$arResult["PROFILE_URL"]?>" title="<?=Loc::getMessage("AUTH_PROFILE")?>"><?=Loc::getMessage("AUTH_PROFILE")?></a><br />
					</td>
				</tr>
				<tr>
					<td align="center">
