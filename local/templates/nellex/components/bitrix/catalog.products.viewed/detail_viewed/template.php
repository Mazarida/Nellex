...
?>
	...
	<?if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS'])):?>
		...
		<div class="page-name"><?=Loc::getMessage('YOU_VIEWED_TITLE')?></div>
		<div class="you__saw-cs">
			<!-- items-container -->
			<div class="swiper-wrapper you-saw-wrapper">
				<?foreach ($arResult['ITEMS'] as $item):?>
					<div class="<?=3 > count($arResult['ITEMS']) ? 'cata__prod' : 'swiper-slide cata__prod'?>">
						<?
						$APPLICATION->IncludeComponent('bitrix:catalog.item', 'main', array(
							'RESULT' => array(
								'ITEM' => $item,
