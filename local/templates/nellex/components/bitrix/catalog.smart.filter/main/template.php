...
<div class="bx-filter col-cata__filter">
	<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
		...
		foreach($arResult["ITEMS"] as $key => $arItem):?>
			...
			<div class="bx-filter-parameters-box bx-active cata__filter-group expand">
				<span class="bx-filter-container-modef"></span>
				<?if ($arItem['CODE'] !== 'GENDER'):?>
					<div class="cata__filter-name"><?=$arItem["NAME"]?></div>
				<?endif;?>
				...
				<?switch ($arItem["DISPLAY_TYPE"]):
					...
					case "G"://CHECKBOXES_WITH_PICTURES
						?>
							<div class="bx-filter-param-btn-inline flex-row f_colors">
								<?foreach ($arItem["VALUES"] as $val => $ar):?>
									...
									<label for="<?=$ar["CONTROL_ID"]?>"
										   ...
										   class="bx-filter-param-label <?=$class?> checks-label-filter-color"
					...
					default:?>
						<?foreach($arItem["VALUES"] as $val => $ar):?>
							<label
								data-role="label_<?=$ar["CONTROL_ID"]?>"
								class="bx-filter-param-label <?=$ar["DISABLED"] ? 'disabled': ''?> flex-row <?=$arItem['CODE'] !== 'GENDER' ? 'checks-label-filter-reverse' : 'checks-label-filter'?>"
								for="<?=$ar["CONTROL_ID"]?>"
								>
								<span class="filter-name" title="<?=$ar["VALUE"];?>">
									<?=$ar["VALUE"];?>
									<?if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):?>
		...
		foreach($arResult["ITEMS"] as $key=>$arItem):?>
			...
			<?if (isset($arItem["PRICE"])):?>
				...
				?>
				<div class="bx-filter-parameters-box cata__filter-group expand">
					<span class="bx-filter-container-modef"></span>
					<div class="cata__filter-name"><?=GetMessage('PRICE_BLOCK_FILTER_TITLE')?></div>
					<div class="flex-row filter-slider-row">
						<label class="checks-label-filter-slider bx-filter-input-container">
							<span class="filter-slider-text"><?=GetMessage("CT_BCSF_FILTER_FROM")?></span>
							<input
								class="min-price filter__slider"
								type="text"
								name="<?echo $arItem["VALUES"]["MIN"]["CONTROL_NAME"]?>"
								id="<?echo $arItem["VALUES"]["MIN"]["CONTROL_ID"]?>"
								value="<?echo $arItem["VALUES"]["MIN"]["HTML_VALUE"]?>"
						...
						<label class="checks-label-filter-slider bx-filter-input-container">
							<span class="filter-slider-text"><?=GetMessage("CT_BCSF_FILTER_TO")?></span>
							<input
								class="max-price filter__slider"
								type="text"
								name="<?echo $arItem["VALUES"]["MAX"]["CONTROL_NAME"]?>"
								id="<?echo $arItem["VALUES"]["MAX"]["CONTROL_ID"]?>"
								value="<?echo $arItem["VALUES"]["MAX"]["HTML_VALUE"]?>"
		...
		<button type="submit" class="filter__submit" id="set_filter" name="set_filter" value="<?=GetMessage("CT_BCSF_SET_FILTER")?>"><?=GetMessage("CT_BCSF_SET_FILTER")?></button>
		<button type="submit" class="filter__cancel-submit" id="del_filter" name="del_filter" value="<?=GetMessage("CT_BCSF_DEL_FILTER")?>"><?=GetMessage("CT_BCSF_DEL_FILTER")?></button>
		<div class="bx-filter-popup-result <?=$arParams["POPUP_POSITION"]?>" id="modef" <?if (!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
