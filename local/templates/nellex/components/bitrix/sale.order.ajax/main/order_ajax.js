...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		locationsCompletion: function()
		{
			...
			// чтобы всегда были открыты Регион и Пользователь закомментировать эти 4 строки
		...
		editSection: function(section)
		{
			...
			// Чтобы убрать действия при клике на заголовки блоков, следует закомментировать следующие строки
			//if (this.result.SHOW_AUTH)
			//{
