...
$MESS["SOA_PAY_LINK"] = "<a href=\"#LINK#\" target=\"_blank\" class=\"btn__cont-shoping\">Оплатить заказ</a>";
$MESS["SOA_PAY_PDF"] = "<a href=\"#LINK#\" target=\"_blank\" class=\"btn__cont-shoping\">Скачать счет (PDF)</a>";
...
$MESS["STOF_REG_HINT"] = "Если вы впервые на сайте, и хотите, чтобы мы вас помнили, и все ваши заказы сохранялись, заполните регистрационную форму.";
...
$MESS["SUCCESS_PRELOAD_TEXT_DEFAULT"] = "Вы заказывали в нашем интернет-магазине, поэтому мы заполнили все данные автоматически. Если все заполнено верно, нажмите кнопку \"#ORDER_BUTTON#\".
";
$MESS["FAIL_PRELOAD_TEXT_DEFAULT"] = "Вы заказывали в нашем интернет-магазине, поэтому мы заполнили все данные автоматически. Обратите внимание на развернутый блок с информацией о заказе. Здесь вы можете внести необходимые изменения или
...
$MESS["ORDER_CONFIRM_FINISH_MSG1"] = "Ваш заказ<br>успешно оформлен";
$MESS["ORDER_CONFIRM_FINISH_MSG2"] = "Спасибо<br>за покупку!";
$MESS["ORDER_CONFIRM_BUTTON_TITLE"] = "Продолжить покупки";
$MESS["GO_TO_PERSONAL_BUTTON_TITLE"] = "В личный кабинет";
