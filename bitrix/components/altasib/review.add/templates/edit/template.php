	...
	<div class="alx_reviews_form">       
        ...
        <div class="alx_reviews_form_item_pole_textarea">
			...
			<div class="alx_reviews_form_textarea_bg">
                <?=\ALTASIB\Review\Tools::showLHE("MESSAGE_PLUS_e",$arResult["arMessage"]["MESSAGE_PLUS"],"MESSAGE_PLUS",100,"oLHErwe");?>
			</div>
		</div>
		<div class="alx_reviews_form_item_pole_textarea">
			<div class="alx_reviews_form_pole_name"><span class="requred_txt">*</span> <?=GetMessage("ALTASIB_TP_MINUS")?>:</div>
			<div class="alx_reviews_form_textarea_bg">
                <?=\ALTASIB\Review\Tools::showLHE("MESSAGE_MINUS_e",$arResult["arMessage"]["MESSAGE_MINUS"],"MESSAGE_MINUS",100,"oLHErwe");?>
			</div>
		</div>
        <?endif;?>
		<div class="alx_reviews_form_item_pole_textarea">
			...
			<div class="alx_reviews_form_textarea_bg">
                <?=\ALTASIB\Review\Tools::showLHE("MESSAGE_e",$arResult["arMessage"]["MESSAGE"],"MESSAGE",200,"oLHErwe");?>
			</div>
		...
		<div class="alx_reviews_form_item_pole_textarea">
			<div class="alx_reviews_form_pole_name"><span class="requred_txt">*</span> <?=GetMessage("ALTASIB_TP_REPLY")?>:</div>
			<div class="alx_reviews_form_textarea_bg">
                <?=\ALTASIB\Review\Tools::showLHE("REPLY",$arResult["arMessage"]["REPLY"],"REPLY",100,"oLHErwe");?>
			</div>
		</div>
              	...
              	<div class="alx_reviews_form_pole_name"><?=GetMessage("ALTASIB_TP_RATING")?>:</div>
                        ...
                        <?
                            for($i=1; $i<=5; $i++):
                                ...
                                <?endif;?>
        				    <div id="altasib_item_vote_edit_0_<?=$i?>" onmouseover="jsReviewVoteEdit.Curr(<?=$i?>,0)" onmouseout="jsReviewVoteEdit.Out(0)" onclick="jsReviewVoteEdit.Set(<?=$i?>,'RATING_e',0)" class="<?=$class?>"></div>
                        <?endfor;?>
                    </div>
			<div class="alx_clear_block">&nbsp;</div>
