...
$arComponentParameters = array(
                ...
                "PARAMETERS" => array(
                                ...
                                "SHOW_TITLE" => array(
                                                "PARENT" => "BASE",
                                                "NAME" => GetMessage("ALTASIB_PM_SHOW_TITLE"),
                                                "TYPE" => "CHECKBOX",
                                                "DEFAULT" => "Y",
                                ),                                
                                "ALLOW_SET" => array(
                                                "PARENT" => "BASE",
                                                "NAME" => GetMessage("ALTASIB_PM_ALLOW_SET"),
                                                "TYPE" => "CHECKBOX",
                                                "DEFAULT" => "Y",
                                ),                                
                ),
...
if($arCurrentValues["SHOW_TITLE"] == "Y" || !isset($arCurrentValues["SHOW_TITLE"]))
{
				$arComponentParameters["PARAMETERS"]["TITLE_TEXT"] = Array(
								"PARENT" => "BASE",
								"NAME" => GetMessage("ALTASIB_PM_SHOW_TITLE_TEXT"),
                                "TYPE" => "STRING",
                                "DEFAULT" => GetMessage("ALTASIB_PM_TITLE"),
	);				
}
?>