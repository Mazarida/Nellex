...
$sTableID = "tbl_altasib_review_complaint";
...
// Set page navigation
$lAdmin->NavText($rsData->GetNavPrint(GetMessage("ALTASIB_REVIEW_AUTHORS_ADMIN_NAV")));

// List headers/columns
$arHeaders = array(
                array("id"=>"ID",               "content"=>"ID",                                                "sort"=>"id",                 "default"=>true),
                array("id"=>"ACTIVE",           "content"=>GetMessage("ALTASIB_REVIEW_HEAD_CC_ACTIVE"),       "sort"=>"active", "default"=>true),
                array("id"=>"DATE_CREATE",      "content"=>GetMessage("ALTASIB_REVIEW_HEAD_CC_DATE_CREATE"),  "sort"=>"date_create", "default"=>true),
                array("id"=>"ELEMENT",          "content"=>GetMessage("ALTASIB_REVIEW_HEAD_CC_ELEMENT"),      "sort"=>"ELEMENT", "default"=>true),
                array("id"=>"REVIEW",          "content"=>GetMessage("ALTASIB_REVIEW_HEAD_CC_COMMENT"),      "default"=>true),
                array("id"=>"MESSAGE",          "content"=>GetMessage("ALTASIB_REVIEW_HEAD_CC_MESSAGE"),      "default"=>true),
                array("id"=>"SENDER",           "content"=>GetMessage("ALTASIB_REVIEW_HEAD_CC_SENDER"),       "sort"=>"user_id", "align"=>"center", "default"=>true),
);
...
while($arRes = $rsData->NavNext(true, "f_"))
{
                ...
                $REVIEW = "<strong>".GetMessage("ALTASIB_REVIEW_CC_LIST_PLUS").":</strong>".$arReview["MESSAGE_PLUS_HTML"]."<br>".
                        "<strong>".GetMessage("ALTASIB_REVIEW_CC_LIST_MINUS").":</strong>".$arReview["MESSAGE_MINUS_HTML"]."<br>".
                        "<strong>".GetMessage("ALTASIB_REVIEW_CC_LIST_COMMENT").":</strong>".$arReview["MESSAGE_HTML"];
...
$lAdmin->AddGroupActionTable(Array(
                ...
                "delete_review"=>GetMessage("ALTASIB_REVIEW_CC_A_DELETE_COMMENT"),
...
$APPLICATION->SetTitle(GetMessage("ALTASIB_REVIEW_CC_ADMIN_TITLE"));
...
$oFilter = new CAdminFilter(
                $sTableID."_filter",
                array(
                                GetMessage("ALTASIB_REVIEW_CC_F_ACTIVE"),
                                GetMessage("ALTASIB_REVIEW_CC_F_COMMENT_ID"),
                                GetMessage("ALTASIB_REVIEW_CC_F_SENDER"),
                )
);
...
?>
        ...
        <tr>
                <td><?echo GetMessage("ALTASIB_REVIEW_CC_F_ACTIVE");?>:</td>
                <td>
                        <?
        ...
        <tr>
                <td><?echo GetMessage("ALTASIB_REVIEW_CC_F_COMMENT_ID")?>:</td>
                <td>
        ...
        <tr>
                <td><?echo GetMessage("ALTASIB_REVIEW_CC_F_SENDER")?>:</td>
                <td>
