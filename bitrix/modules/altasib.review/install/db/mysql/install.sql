CREATE TABLE IF NOT EXISTS `altasib_review` (
...
CREATE TABLE IF NOT EXISTS `altasib_review_complaint` (
...
CREATE TABLE IF NOT EXISTS `altasib_review_file` (
...
CREATE TABLE IF NOT EXISTS `altasib_review_rating2element` (
  `ID` int(18) NOT NULL AUTO_INCREMENT,
  `TIMESTAMP_X` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `USER_ID` int(18) DEFAULT NULL,
  `ELEMENT_ID` int(18) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `altasib_review_subs` (
  `ELEMENT_ID` int(18) NOT NULL,
  `EMAIL` varchar(255) NOT NULL
);

CREATE TABLE IF NOT EXISTS `altasib_review_user` (
  `ID` int(18) NOT NULL AUTO_INCREMENT,
  `USER_ID` int(18) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `altasib_review_vote_to_review` (
  `TIMESTAMP_X` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `USER_ID` int(18) NOT NULL,
  `REVIEW_ID` int(18) NOT NULL,
  `IP` varchar(15) DEFAULT NULL
