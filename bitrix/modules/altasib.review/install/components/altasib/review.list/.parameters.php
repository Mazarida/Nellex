...
//BASE                                
		"ALLOW_VOTE" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ALTASIB_PM_ALLOW_VOTE"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"ONLY_AUTH_COMPLAINT" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ALTASIB_PM_ONLY_AUTH_COMPLAINT"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"MOD_GOUPS" => array(
...
//VISUAL           
		...
		"LIST_TITLE" => array(
			"PARENT" => "VISUAL",
			"NAME" => GetMessage("ALTASIB_REVIEW_CMP_PM_LIST_TITLE"),
			"TYPE" => "STRING",
			"DEFAULT" => "",
		),
		"EMPTY_MESSAGE" => array(
			"PARENT" => "VISUAL",
			"NAME" => GetMessage("ALTASIB_REVIEW_CMP_PM_EMPTY_MESSAGE"),
			"TYPE" => "STRING",
			"DEFAULT" => GetMessage("ALTASIB_REVIEW_CMP_PM_EMPTY_MESSAGE_1"),
		),
