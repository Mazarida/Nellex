...
<div class="alx_reviews_list" id="alx_reviews_list">
	...
	<div class="alx_reviews_item" id="review-list-review-<?=$arReview["ID"]?>">
		...
		<div class="alx_reviews_vote_item">
			...
			<div class="alx_reviews_item_vote_show"><a href="javascript:void(0)" onclick="ReviewShowVotes(<?=$arReview["ID"]?>)"><?=GetMessage('ALTASIB_REVIEW_T_REVIEW_LIST_SHOW_ALL_VOTES')?></a></div>
        ...
        <div class="alx_reviews_item_link"><noindex><a rel="nofollow" href="<?=$arReview['ELEMENT']['DETAIL_PAGE_URL']?>#review<?=$arReview["ID"];?>"><?=GetMessage('ALTASIB_REVIEW_T_REVIEW_LINK')?></a></noindex></div>
		<div class="alx_clear_block">&nbsp;</div>
	</div>
  <?endforeach;?>
</div>
