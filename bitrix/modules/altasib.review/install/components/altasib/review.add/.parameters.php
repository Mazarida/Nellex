...
$arCurrentValues["SEF_BASE_URL"] = str_replace("#SITE_DIR#", $langDir,
	$arIBlockToUrl[$arCurrentValues["IBLOCK_ID"]]["LIST_PAGE_URL"]);
$arCurrentValues["DETAIL_PAGE_URL"] = str_replace(array("#SITE_DIR#", $arCurrentValues["SEF_BASE_URL"]),
	array($langDir, ""), $arIBlockToUrl[$arCurrentValues["IBLOCK_ID"]]["DETAIL_PAGE_URL"]);
...
//DATA
		...
		"DETAIL_PAGE_URL" => CIBlockParameters::GetPathTemplateParam("DETAIL", "DETAIL_PAGE_URL",
			GetMessage("ALTASIB_PM_DETAIL_PAGE_URL"), $arCurrentValues["DETAIL_PAGE_URL"], "DATA_SOURCE"),
		"ELEMENT_ID" => array(
			"PARENT" => "DATA_SOURCE",
...
//BASE
		...
		"SEND_NOTIFY" => array(
			"PARENT" => "BASE",
			"NAME" => GetMessage("ALTASIB_PM_SEND_NOTIFY"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
//VISUAL
		"SHOW_POPUP" => array(
			"PARENT" => "VISUAL",
			"NAME" => GetMessage("ALTASIB_PM_SHOW_POPUP"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
		),
		"UF" => array(
...
//FIELDS
		"SHOW_MAIN_RATING" => array(
			"PARENT" => "FIELDS",
			"NAME" => GetMessage("ALTASIB_PM_SHOW_MAIN_RATING"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"TITLE_MIN_LENGTH" => array(
			"PARENT" => "FIELDS",
			"NAME" => GetMessage("ALTASIB_PM_TITLE_MIN_LENGTH"),
			"TYPE" => "STRING",
			"DEFAULT" => "5",
		),
...
$arComponentParameters["PARAMETERS"]["SAVE_COUNT"] = array(
	"PARENT" => "BASE",
	"NAME" => GetMessage("ALTASIB_PM_SAVE_COUNT"),
	"TYPE" => "CHECKBOX",
	"DEFAULT" => "N",
	"REFRESH" => "Y",
);
...
if ($arCurrentValues["SAVE_COUNT"] == 'Y') {
	$arComponentParameters["PARAMETERS"]["SAVE_COUNT_IB_PROPERTY"] = Array(
		"PARENT" => "BASE",
		"NAME" => GetMessage("ALTASIB_PM_SAVE_COUNT_IB_PROPERTY"),
		"VALUES" => $arProps,
		"MULTIPLE" => "Y",
		"ADDITIONAL_VALUES" => "Y",
...
$arComponentParameters["PARAMETERS"]["UPLOAD_FILE_TYPE"] = Array(
	...
	"TYPE" => "STRING",
	"DEFAULT" => COption::GetOptionString("altasib.review", "upload_file_types",
		"jpg,jpeg,gif,png,ppt,doc,docx,xls,xlsx,odt,odp,ods,odb,rtf,txt"),
);
...
if ($arCurrentValues["CATALOG_IS_SEF"] === "Y") {
