...
<div>
<?if(!$arParams['SHOW_FORM']):?><div class="alx_add_reviews_a" id="review_show_form"><a href="javascript:void(0)" onclick="ShowReviewForm();"><?echo strlen($arParams["ADD_TITLE"]) ==0 ? GetMessage("ALTASIB_TP_ADD") : $arParams["ADD_TITLE"]?></a></div><?endif;?>
<?if($arParams['SHOW_FORM']):?>
<div id="review_add_form" >
<form name="review_add" id="review_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" value="Y" name="POPUP">
    <input type="hidden" value="go" name="review_add_btn" />
	...
	<div class="alx_reviews_form">
        ...
        <div class="alx_reviews_form_vote" id="alx_reviews_form_vote">
            ...
            <?if($arParams['SHOW_MAIN_RATING']):?>
              	<div class="alx_reviews_form_pole_name"><?if($arParams["REQUIRED_RATING"]):?><span class="requred_txt">*</span> <?endif;?><?=GetMessage("ALTASIB_TP_RATING")?>:</div>
