	...
	<div class="alx_reviews_form">       
        ...
        <div class="alx_reviews_form_item_pole_textarea">
			...
			<div class="alx_reviews_form_textarea_bg">
                <?=aReview::ShowLHE("MESSAGE_PLUS_e",$arResult["arMessage"]["MESSAGE_PLUS"],"MESSAGE_PLUS",100,"oLHErwe");?>
			</div>
		</div>
		<div class="alx_reviews_form_item_pole_textarea">
			<div class="alx_reviews_form_pole_name"><span class="requred_txt">*</span> <?=GetMessage("ALTASIB_TP_MINUS")?>:</div>
			<div class="alx_reviews_form_textarea_bg">
                <?=aReview::ShowLHE("MESSAGE_MINUS_e",$arResult["arMessage"]["MESSAGE_MINUS"],"MESSAGE_MINUS",100,"oLHErwe");?>
			</div>
		</div>
        <?endif;?>
		<div class="alx_reviews_form_item_pole_textarea">
			...
			<div class="alx_reviews_form_textarea_bg">
                <?=aReview::ShowLHE("MESSAGE_e",$arResult["arMessage"]["MESSAGE"],"MESSAGE",200,"oLHErwe");?>
			</div>
		...
		<div class="alx_reviews_form_item_pole_textarea">
			...
			<div class="alx_reviews_form_textarea_bg">
                <?=aReview::ShowLHE("REPLY",$arResult["arMessage"]["REPLY"],"REPLY",100,"oLHErwe");?>
			</div>
		</div>
